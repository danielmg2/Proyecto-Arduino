    ...
    <div class="container-fluid d-flex flex-column col-6 justify-content-center mt-5" id="filtros">
        ...
        <form action="index.php" >
            ...
            <div class="mb-3 ms-5">
                <label for="input1" class="form-label"> Actuador </label>
                <input type="datetime-local" class="form-control" id="fechaInicio" aria-describedby="fechaInicio">
            </div>
            ...
            <div class="mb-3 ms-5">
                <select class="form-select" id="actuador" aria-label="Actuador">
                    ...
                    <option value="ventilador">One</option>
                    <option value="calefaccion">Two</option>
